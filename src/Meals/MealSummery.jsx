...
const MealSummery = () => {
  return (
    <section className={classes.summery}>
      ...
      <p>
        The key to our success is simple: providing quality consistent food that
        taste great every single time.
      </p>
      <p>
        We pride ourselves on serving our customers delicious genuine dishes
        like: Coffee, Breakfast, Donuts, Bakey, Pastry. Eat delicious food. Grab
        a drink. But most of all, relax! We thank you from the bottom of our
